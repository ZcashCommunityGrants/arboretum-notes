...
+ ECC Core Update - [Mobile SDK -rc 3 / Zcashd updated binary]()

+ Research & Implementation Update - [FROST audit / planned community call]() / [TFL Research / Snap-and-Chat design]() / [ZSA circuit optimisations / issuance curve / wallet support]() 

+ Open Discussion - [Zebra wallet support / ZIP editor update]() / [Network Upgrade Process]()
