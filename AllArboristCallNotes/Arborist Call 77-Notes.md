...
+ ECC Core Update - [Binance TEX addresses / Zashi currency conversion]()

+ Zebra Update - [Zebra 1.7.0 / Regtest tutorial]()

+ [ECC & ZF Zcashd Deprecation]()

+ Research & Implementation Update - [Zcash Shielded Assets ZIPs]() / [FROST demo]() / [TFL presentation]()

+ Open Announcements - [My First Zcash Workbook]()

+ Open Discussion - [Memo Bundle Design]() / [Memo Bundle Design cont.]()
